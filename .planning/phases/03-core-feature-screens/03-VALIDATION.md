...
| 03-01-04 | 01 | 1 | LIST-03 | unit | `pnpm vitest run packages/app-desktop/src/pages/processos/processos-page.test.ts` | ❌ W0 | ⬜ pending |
| 03-02-01 | 02 | 2 | DASH-01 | manual | visual: stat cards render with trend indicators | N/A | ⬜ pending |
...
- [ ] `packages/app-desktop/src/pages/processos/processos-page.test.ts` — stubs for LIST-03 (status mapping function)
...
|----------|-------------|------------|-------------------|
| Stat cards render Stripe-style with trend indicators | DASH-01 | Visual layout quality | Open dashboard, verify cards show KPIs with up/down arrows |
