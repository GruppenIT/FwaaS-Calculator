...
--> statement-breakpoint
CREATE UNIQUE INDEX `roles_nome_unique` ON `roles` (`nome`);--> statement-breakpoint
CREATE TABLE `users` (
	`id` text PRIMARY KEY NOT NULL,
	`nome` text NOT NULL,
	`email` text NOT NULL,
...
CREATE TABLE `movimentacoes` (
	...
	`lido` integer DEFAULT false NOT NULL,
	`created_at` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `processos_numero_cnj_unique` ON `processos` (`numero_cnj`);--> statement-breakpoint
...
CREATE TABLE `licencas` (
	...
	`features_ativas` text
);
--> statement-breakpoint
CREATE UNIQUE INDEX `licencas_chave_licenca_unique` ON `licencas` (`chave_licenca`);--> statement-breakpoint
